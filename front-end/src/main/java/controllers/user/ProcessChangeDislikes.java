 ...
 * @author pc
 */
@WebServlet(name = "ProcessChangeDislikes", urlPatterns = {"/ProcessChangeDislikes"})
public class ProcessChangeDislikes extends HttpServlet {
	/** 
    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           int numdislikes = yourdata.getInt("numberdislikes");
           //lay ra user tu db
